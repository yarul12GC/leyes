  ...
  menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'DECRETO  que reforma el diverso por el que se establecen distintos Programas de Promoción Sectorial. (PROSEC)', icon: 'fas fa-circle', link: '/decre13', submenu: [] },
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: '-  Anexo 1 de Las RGCE', icon: 'fas fa-circle', link: '/anexo1', submenu: [] },
        { title: '-  Anexo 2 de Las RGCE', icon: 'fas fa-circle', link: '/anexo2', submenu: [] },
        { title: '-  Anexo 3 de Las RGCE', icon: 'fas fa-circle', link: '/anexo3', submenu: [] },
        { title: '-  Anexo 4 de Las RGCE', icon: 'fas fa-circle', link: '/anexo4', submenu: [] },
        { title: '-  Anexo 5 de Las RGCE', icon: 'fas fa-circle', link: '/anexo5', submenu: [] },
        { title: '-  Anexo 6 de Las RGCE', icon: 'fas fa-circle', link: '/anexo6', submenu: [] },
        { title: '-  Anexo 7 de Las RGCE', icon: 'fas fa-circle', link: '/anexo7', submenu: [] },
        { title: '-  Anexo 8 de Las RGCE', icon: 'fas fa-circle', link: '/anexo8', submenu: [] },
        { title: '-  Anexo 9 de Las RGCE', icon: 'fas fa-circle', link: '/anexo9', submenu: [] },
        { title: '-  Anexo 10 de Las RGCE', icon: 'fas fa-circle', link: '/anexo10', submenu: [] },
        { title: '-  Anexo 11 de Las RGCE', icon: 'fas fa-circle', link: '/anexo11', submenu: [] },
        { title: '-  Anexo 12 de Las RGCE', icon: 'fas fa-circle', link: '/anexo12', submenu: [] },
        { title: '-  Anexo 13 de Las RGCE', icon: 'fas fa-circle', link: '/anexo13', submenu: [] },
        { title: '-  Anexo 14 de Las RGCE', icon: 'fas fa-circle', link: '/anexo14', submenu: [] },
        { title: '-  Anexo 15 de Las RGCE', icon: 'fas fa-circle', link: '/anexo15', submenu: [] },
        { title: '-  Anexo 16 de Las RGCE', icon: 'fas fa-circle', link: '/anexo16', submenu: [] },
        { title: '-  Anexo 17 de Las RGCE', icon: 'fas fa-circle', link: '/anexo17', submenu: [] },
        { title: '-  Anexo 18 de Las RGCE', icon: 'fas fa-circle', link: '/anexo18', submenu: [] },
        { title: '-  Anexo 19 de Las RGCE', icon: 'fas fa-circle', link: '/anexo19', submenu: [] },
        { title: '-  Anexo 20 de Las RGCE', icon: 'fas fa-circle', link: '/anexo20', submenu: [] },
        { title: '-  Anexo 21 de Las RGCE', icon: 'fas fa-circle', link: '/anexo21', submenu: [] },
        { title: '-  Anexo 22 de Las RGCE', icon: 'fas fa-circle', link: '/anexo22', submenu: [] },
        { title: '-  Anexo 23 de Las RGCE', icon: 'fas fa-circle', link: '/anexo23', submenu: [] },
        { title: '-  Anexo 24 de Las RGCE', icon: 'fas fa-circle', link: '/anexo24', submenu: [] },
        { title: '-  Anexo 25 de Las RGCE', icon: 'fas fa-circle', link: '/anexo25', submenu: [] },
        { title: '-  Anexo 26 de Las RGCE', icon: 'fas fa-circle', link: '/anexo26', submenu: [] },
        { title: '-  Anexo 27 de Las RGCE', icon: 'fas fa-circle', link: '/anexo27', submenu: [] },
        { title: '-  Anexo 28 de Las RGCE', icon: 'fas fa-circle', link: '/anexo28', submenu: [] },
        { title: '-  Anexo 29 de Las RGCE', icon: 'fas fa-circle', link: '/anexo29', submenu: [] },
        { title: '-  Anexo 30 de Las RGCE', icon: 'fas fa-circle', link: '/anexo30', submenu: [] },
    ...
    },
    {
      ...
      link: '/leyes',
      submenu: [
        { title: 'Precios Estimados', icon: 'fas fa-circle', link: '/reso1', submenu: [] },
